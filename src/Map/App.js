...
mapboxgl.accessToken = "pk.eyJ1IjoiaGltYWxpMjUxMCIsImEiOiJja2IzeXUxNW0wZTJ5MnlvOXY5a3ZyZm1hIn0.mu36YqyOK6FTYTyBryekjQ";
const Mylocation = {
    center: { lon: 72.58836, lat: 23.01953 },
    zoom: 15.82,
    pitch: 0.00,
    bearing: 0.00
}
            ...
            map.once("load", function () {
                ...
                map.on("mousemove", "circles", e => {
                    ...
                    if (id !== lastId) {
                        ...
                        const provinceHTML =
                            province !== "null" ? `<p>Province: <b>${province}</b></p><u>` : "";
